...
export default function ModalContactUs({
  ...
  return (
    <Modal
      isShowing={parentShowing !== null ? parentShowing : isShowingContactUs}
    ...
    >
      ...
      <ModalSubTitle>
        Je jure de parler sans haine et sans crainte, de dire toute la vérité,
        <br />
        rien que la vérité.
      </ModalSubTitle>
      ...
      <ModalBody>
        <Container>
                  ...
                  <InputGroup>
                    <Input
                      ...
                      isInvalid={
                        dirty &&
                        touched.phoneNumber &&
                        (errors.phoneNumber || errors.global)
                      }
                    />
                    {errors.phoneNumber && (
          ...
          <p className={'phone-contact'}>
            Jean-Michel est aussi joignable au &nbsp;
            <CopyToClipBoard
              toCopy={'+33755540503'}
