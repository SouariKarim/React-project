...
const ModalPasswordRecovery = () => {
    ...
    const {toggleLogin, togglePasswordRecovery, isShowingPasswordRecovery} = useContext(ModalContext);
    ...
    return (
        <Modal isShowing={isShowingPasswordRecovery}
                ...
                <Container>
                    <Row className="justify-content-md-center">
                        <Col>
                            ...
                            <p>Jean-Michel vous enverra un mot de passe tout beau, tout neuf</p>
                        </Col>
                    </Row>
                    <Formik
                        initialValues={{email: ''}}
