...
export default function SideBar({ children }) {
  ...
  const { toggleContactUsToSubscribe, toggleContactUs } = useContext(ModalContext);
      ...
      >
        <div className="side-content">
          <ul>
            <li className={"brand"}>
              <Link to={"HOME_PAGE"}>
                <img
                    ...
                    alt={"Jean-Michel"}
                />
                <motion.p variants={motionSidebarContent} className={"brand-text"}>
                  JEAN-MICHEL.io
                </motion.p>
              </Link>
            </li>
            ...
            <li>
              <Button variant={"navlink"} activeClassName={"active"} to={"SEARCH"}>
            ...
            <li>
              <Button variant={"navlink"} activeClassName={"active"} to={"SAVED_RESEARCH"}>
            ...
            <li>
              <Button variant={"navlink"} activeClassName={"active"} to={"BOOKMARK"}>
            ...
            <motion.li variants={motionSidebarContent} className={"heading content-expand"}>
              ANNONCES
            </motion.li>
            <li>
              <Button variant={"navlink"} activeClassName={"active"}  disabled={true}>
          ...
          <motion.div variants={motionSidebarContent} className={"sidebar-footer"}>
            <p>{user.credits_consume} / {user.credits_available} ouvertures de CV ce mois</p>
