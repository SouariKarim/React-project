...
export default function FreelanceDisplay() {
    ...
    const {profileToDisplay, closeFreelanceDisplay} = useContext(DisplayFreelanceContext)
    ...
    const toggleLoading = (bool) => {
        ...
        if(bool === true && profileToDisplay !== null){
            setDisplayMessage(<p>Chargement du profil de {profileToDisplay.first_name} ...</p>)
        }
        else{
            setDisplayMessage(<p>Jean-Michel SHORTCUT : <span className={"shortcut"}>Echap</span> ferme directement le profil ouvert</p>)
        }
    }
