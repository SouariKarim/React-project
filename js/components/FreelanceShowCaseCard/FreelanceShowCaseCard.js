// render a link containig the freelancer picture and contacts
...
export default function FreelanceShowCaseCard({ freelance }) {
  return (
    // this is a link pointing to the freelancer profile infos
    <Link
      to={'FREELANCE_PROFILE'}
      toParams={{ id: freelance.id }}
      className={'freelance-showcase-card mt-4'}
    >
      {/* render the freelancer profile picture */}
      ...
      <div className={'freelance-showcase-info'}>
        ...
        {/* render to freelancer contacts info */}
