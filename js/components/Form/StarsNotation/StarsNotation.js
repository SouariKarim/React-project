...
export default function StarsNotation({
  value,
  setValue,
  className,
  disabled = false,
  ...
  return (
    ...
    >
      {starLabel.map(
        (
          label,
          index // maps the starlabel array to get the 5 stars notation
        ) => (
          <FontAwesomeIcon
            title={label}
      ...
      {/* reset the notation functionality */}
