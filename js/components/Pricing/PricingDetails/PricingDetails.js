// render the table wich the check marks below the pricing cards
    ...
    <div className='pricing-details w-100'>
      <Table>
        ...
        <tbody>
          ...
          <tr>
            <th>
              Poster des commentaires privés et des notations sur les freelances
            </th>
            <th>
              <Checked />
            </th>
          ...
          <tr>
            <th>
              Accès aux {valueWithSpaces(totalFreelances)} freelances standards
            </th>
            <th>
              <Checked />
            </th>
          ...
          <tr>
            <th>
              Accès aux {valueWithSpaces(totalPremiumFreelances)} freelances
              premiums
            </th>
            <th>
              <NotChecked />
        ...
        <thead>
          <tr>
            <th>
              <h3>annonces et intercontrats</h3>
            </th>
            <th />
            <th />
            <th />
          ...
          <tr className='no-bg-color'>
            ...
            <th>
              <Button
                ...
                onClick={() => {
                  clickCta({
                    subscriptionCode: Constant.SUBSCRIPTION_CODE_RADIN,
                  });
                }}
            ...
            <th>
              <Button
                ...
                onClick={() => {
                  clickCta({
                    subscriptionCode: Constant.SUBSCRIPTION_CODE_SMART,
                  });
                }}
                disabled={disabledButton({
