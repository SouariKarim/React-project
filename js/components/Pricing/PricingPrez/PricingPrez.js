...
import PricingPrice from '../PricingPrice/PricingPrice'; // render the price
...
export default function PricingPrez({ className = '', metrics }) {
  ...
  const disabledButton = ({ code }) => {
    ...
    const subscriptions = [
      ...
      Constant.SUBSCRIPTION_CODE_SMART,
      Constant.SUBSCRIPTION_CODE_TOUT_PUISSANT,
    ];

    const indexSubcriptionCode = subscriptions.findIndex(
      (value) => value === subcriptionCode
    );
      ...
      <Row className='py-3 align-items-center justify-content-center position-relative mb-6'>
        ...
        >
          ...
          <div className='pricing-prez-offers my-3'>
            <span className={'main-offer'}>
              1 accès restreint<sup>*</sup>
            </span>
            <span>
              <FontAwesomeIcon icon={faCheck} />
              Accès aux {valueWithSpaces(totalFreelances)} profils standards
            </span>
            <span>
              <FontAwesomeIcon icon={faCheck} /> Liens vers les profils LinkedIn
            </span>
            <span className={'not-include-offer'}>
              <FontAwesomeIcon icon={faTimes} />
              Accès aux coordonnées et TJM
            </span>
            <span className={'not-include-offer'}>
              <FontAwesomeIcon icon={faTimes} />
              Accès aux {valueWithSpaces(totalPremiumFreelances)} profils
              Premium
            </span>
          </div>
          ...
          <Button
            ...
            disabled={disabledButton({
              code: Constant.SUBSCRIPTION_CODE_RADIN,
            })}
          >
            ALLEZ
          </Button>
        ...
        <Col
          as={Card}
          className='main-card text-center align-items-center p-3'
          xs={12}
          lg={4}
        >
          ...
          <PricingPrice
            price={Constant.PRICING_SMART}
            priceWithReduction={Constant.PRICING_SMART_REDUCTION}
          />

          <div className='pricing-prez-offers my-3'>
            <span className={'main-offer'}>
              1 accès illimité<sup>*</sup>
            </span>
            <span>
              <FontAwesomeIcon icon={faCheck} />
              Accès aux {valueWithSpaces(totalFreelances)} profils standards
            ...
            <span>
              <FontAwesomeIcon icon={faCheck} /> Accès aux coordonnées et TJM
            </span>
            <span>
              <FontAwesomeIcon icon={faCheck} /> Accès aux{' '}
              {valueWithSpaces(totalPremiumFreelances)} profils Premium
            </span>
          </div>
          ...
          <Button
            ...
            disabled={disabledButton({
              code: Constant.SUBSCRIPTION_CODE_SMART,
            })}
          >
            VIENS
          </Button>
          ...
          <div className='further-info'>
            <p>
              Un seul consultant signé grâce à <br />
              Jean-Michel.io rentabilise 2 ans d'abonnement !
            </p>
          </div>
        </Col>
        ...
        >
          ...
          <PricingPrice
            price={Constant.PRICING_TOUT_PUISSANT}
            priceWithReduction={Constant.PRICING_TOUT_PUISSANT_REDUCTION}
          />

          <div className='pricing-prez-offers my-3'>
            <span className={'main-offer'}>
              3 accès illimités<sup>*</sup>
            </span>
            <span>
              <FontAwesomeIcon icon={faCheck} />
              Accès aux {valueWithSpaces(totalFreelances)} profils standards
          ...
          <Button
            ...
            onClick={() =>
              clickCta({
                subscriptionCode: Constant.SUBSCRIPTION_CODE_TOUT_PUISSANT,
              })
            }
            disabled={disabledButton({
              code: Constant.SUBSCRIPTION_CODE_TOUT_PUISSANT,
            })}
          >
            ON EST BIEN
          </Button>
          ...
          <div className='further-info'>
            <p>
              Jean-Michel recueille un chaton abandonné pour chaque souscription
            </p>
          </div>
